...
#	$(Q)$(MAKE) -C linux-mt ARCH=arm64 CROSS_COMPILE=${K_CROSS_COMPILE} -j$J headers_install
	mkdir -p linux-mt/output/lib/modules/4.4.92-BPI-R64-Kernel/extra
	cp mtk_wifi/mt_wifi_ap/mt_wifi.ko linux-mt/output/lib/modules/4.4.92-BPI-R64-Kernel/extra/
