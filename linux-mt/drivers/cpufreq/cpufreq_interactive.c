...
#if MT7622_SET_MAX_FREQ
#define NUM_OF_PREV_FREQ 8
static unsigned int max_freq;
/* static unsigned int temp_log = 0; */
static unsigned int prev_freq[NUM_OF_PREV_FREQ] = {0};
#endif
	...
	for (index = 0; index < NUM_OF_PREV_FREQ - 1; index++) {
		...
		/* pr_err("%d:%d,", index, prev_freq[index]); */
	}
