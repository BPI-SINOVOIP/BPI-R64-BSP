...
int ei_qdma_ioctl(struct net_device *dev, struct ifreq *ifr, int cmd);
...
#else
static inline int fe_hw_lro_init(struct net_device *dev)
{
	return 0;
}

static inline void fe_hw_lro_deinit(struct net_device *dev)
{
}

static inline int fe_hw_lro_recv(struct net_device *dev,
				 struct napi_struct *napi,
				 int budget)
{
	return 0;
...
static inline void fe_set_hw_lro_my_ip(char *lan_ip_addr)
{
}
#endif
