...
#define ENV_BOOT_WRITE_IMAGE \
	...
	";snor write ${loadaddr} " __stringify(CONFIG_NOR_LINUX_OFFSET) " 0xF20000;fi\0"
...
#define CONFIG_MAX_UBOOT_SIZE                           0x60000  //262144
...
#define ENV_WRITE_FLASHIMAGE \
	...
	";nand write ${loadaddr} " __stringify(CONFIG_NAND_FLASHIMAGE_OFFSET) " 8000000;fi\0"
...
#define CONFIG_SYS_PROMPT		            "BPI-R64-k4.4> "
